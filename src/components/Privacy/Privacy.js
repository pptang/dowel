  ...
  <div id="Privacy">
    ...
    <ul>
      ...
      <li>
        ...
        in this Agreement) refers to creativemashimashi.
      </li>
      <li>
      ...
      <li>
        <b>Website</b> refers to creativemashimashi, accessible
        from http://creativemashimashi.com
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        ...
        objects?" available
        at https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_
      </li>
      <li>
    ...
    <p>We may share You personal information in the following situations:</p>
    <ul>
      <li>
      ...
      <li>
        <b>With You consent</b>We may disclose Your personal information for any
    ...
    <ul>
      <li>Comply iwth a legal obligation</li>
    ...
    <ul>
      <li>By email: creativemashimashi@gmail.com</li>
    </ul>
  </div>
);
